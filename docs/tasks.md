...
- **notes:** (2026-09-13) Written and validated; **nothing applied**. Waiting on the founder to create an IAM user or role for Terraform — `js-ai-lab-cli` can read EC2 but cannot manage IAM, Route 53, Budgets or DLM, and cannot call the Pricing API either (prices came from ec2.shop).
